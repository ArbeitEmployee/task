...
const CourseList = () => {
  ...
  const handleDeleteContent = async (courseId) => {
    if (window.confirm("Are you sure you want to delete this course?")) {
      try {
        await axios.delete(
          `${base_url}/api/teacher/delete-content/${courseId}`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("teacherToken")}`,
            },
                        ...
                        <img
                          ...
                          src={
                            viewingCourse.thumbnail?.path
                              ? `${base_url}/courses/${viewingCourse.thumbnail.path}`
